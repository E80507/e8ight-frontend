...
import CalendarDouble from "@/app/_components/calendar-single";
...
const FilterSearchBox = ({
  ...
  const [selectedCategoryType, setSelectedCategoryType] = useState<string>("all"); // 카테고리
  ...
  useEffect(() => {
    filterData();
  }, [keyword, selectedCategoryType, data]);
