...
interface ChargeStatusInfoProps {
  data: PointChargeRes;
}

const ChargeStatusInfo = ({ data }: ChargeStatusInfoProps) => {
  return (
    <div className="flex w-full flex-col gap-4">
      <p className="heading-4">충전 상태 정보</p>
      <div className="w-full shrink-0">
        <ShortRow
          size="md"
          label="충전 상태"
          value={handlePointChargeStatusText(data.status)}
        />
...
export default ChargeStatusInfo;
